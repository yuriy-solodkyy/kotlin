...
public class KtNamedFunction extends KtTypeParameterListOwnerStub<KotlinFunctionStub>
    ...
    public List<KtTypeReference> getAdditionalReceiverTypeReferences() {
        KotlinFunctionStub stub = getStub();
        if (stub != null) {
            KtAdditionalReceiverList childAdditionalReceiverList = getStubOrPsiChild(KtStubElementTypes.ADDITIONAL_RECEIVER_LIST);
            if (childAdditionalReceiverList != null) {
                return childAdditionalReceiverList.typeReferences();
            }
            else {
    ...
    private List<KtTypeReference> getAdditionalReceiverTypeRefByTree() {
        ...
        while (child != null) {
            ...
            if (child instanceof KtAdditionalReceiverList) {
                return ((KtAdditionalReceiverList) child).typeReferences();
            }
    ...
    public List<KtExpression> getAdditionalReceiverObjects() {
        ...
        while (child != null) {
            if (child instanceof KtAdditionalReceiverObjectList) {
                return ((KtAdditionalReceiverObjectList) child).additionalReceiverObjectExpressions();
            }
            child = child.getNextSibling();
        }
        return Collections.emptyList();
