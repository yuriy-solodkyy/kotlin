...
internal class MetadataBuildingVisitor : CirNodeVisitor<VisitingContext, Any?> {
    private val classConsumer = ClassConsumer()

    override fun visitRootNode(node: CirRootNode, context: VisitingContext): Pair<Target, Collection<KlibModuleMetadata>> {
